        ...
        <div className="bg-[#18181b] rounded-2xl border border-[#27272a] overflow-hidden">
          <div className="flex flex-wrap items-center gap-3 p-4 border-b border-[#27272a]">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium rounded-xl transition-all hover:opacity-90 hover:shadow-lg"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 p-4">
            <div className="border border-[#27272a] rounded-xl overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-3 border-b border-[#27272a] bg-[#09090b]">
                ...
                <span className="text-sm font-medium text-zinc-300">原始YAML（左侧）</span>
              </div>
              <textarea
                value={leftText}
...
value: 123`}
            ...
            <div className="border border-[#27272a] rounded-xl overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-3 border-b border-[#27272a] bg-[#09090b]">
                ...
                <span className="text-sm font-medium text-zinc-300">新YAML（右侧）</span>
              </div>
              <textarea
                value={rightText}
...
value: 123`}
        ...
        <div className="bg-[#18181b] rounded-2xl border border-[#27272a] p-6">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            在线对比两个YAML配置的差异，高亮显示新增、删除、修改的内容。绿色标记表示新增内容，红色标记表示删除内容。
            所有处理在浏览器本地完成，数据安全可靠。
          </p>
        </div>
      </div>
