...
export default function CapitalizeCasePage() {
  ...
  return (
    <ToolLayout
      title="单词首字母大写"
      description="将文本中每个单词的首字母转换为大写，其余字母保持原样，支持中英文混合文本"
      toolId="capitalize-case"
      icon={Type}
      category="文本工具"
      slug="capitalize-case"
    >
      <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
            ...
            <div className="p-3 border-t border-zinc-200 dark:border-zinc-800">
              <button
                onClick={handleCopy}
                disabled={!output}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm text-zinc-600 dark:text-zinc-400 hover:text-sky-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {copied ? (
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
          ...
          <div className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
            将文本中每个单词的首字母转换为大写，其余字母保持原样，支持中英文混合文本，纯前端本地处理，数据不会上传到服务器。
          </div>
        </div>
      </div>
    </ToolLayout>
